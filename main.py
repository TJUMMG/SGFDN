...
# CUDA_VISIBLE_DEVICES=1,2 python -m torch.distributed.launch --nproc_per_node=2 --use_env main.py --combine_datasets=vidstg --combine_datasets_val=vidstg --dataset_config config/vidstg.json --output-dir='results/vidstg_resultres448' --decompose --tmp_crop --resolution=448
#1. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation1' --tmp_crop --decompose --att_decompose
#2. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation2' --tmp_crop --att_decompose
#3. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation3' --tmp_crop --decompose
#4. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation4' --tmp_crop
#5. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation5' --tmp_crop --decompose_type=mean --decompose --att_decompose
#6. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation6' --tmp_crop --decompose_type=weighted_wo_group --decompose --att_decompose
#7. python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation7' --tmp_crop  --decompose --att_decompose  [no pyramid 1*1]
#8: python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation8' --tmp_crop  --decompose --att_decompose --not_decoder_obj
#9: python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation9' --tmp_crop  --decompose --att_decompose --loss_temporal_dist=2   not good
#9: python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation9' --tmp_crop  --decompose --att_decompose --loss_spatial_hm=2 
#10: python main.py --combine_datasets=hcstvg --combine_datasets_val=hcstvg --dataset_config config/hcstvg.json --output-dir='results/hcstvg_ablation10' --decompose --att_decompose --loss_spatial_hm=2  --layers=8
#10: python main.py --combine_datasets=vidstg --combine_datasets_val=vidstg --dataset_config config/vidstg.json --output-dir='results/vidstg_ablation1' --decompose --att_decompose --loss_spatial_hm=2  --layers=8

def get_args_parser():
    parser = argparse.ArgumentParser("Set DecomposedSTVG", add_help=False)

    # Dataset specific
    parser.add_argument("--dataset_config", default='', required=True)
    parser.add_argument(
        "--combine_datasets",
        nargs="+",
    ...
    parser.add_argument(
        ...
        default=True,
        type=bool,
        help="If true, we extract the features from last three ResNet layers as the visual feature",
    )
    ...
    # for anchor-based temporal decoder
    #+++++++++++++++++++++++++++++++++++++
    parser.add_argument(
    ...
    # [6, 12, 24, 36, 48, 72, 96] hcstvg
    # [8, 16, 32, 64, 96, 128, 164, 196] vidstg
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        choices=['anchor', 'regression', 'distribution']
    )
    parser.add_argument(
        "--decompose",
        action="store_true"
    ...
    parser.add_argument(
        ...
        default='weighted',
        type=str,
        choices=['weighted', 'mean', 'weighted_wo_group']
    )
    parser.add_argument(
        "--att_decompose",
        action="store_true"
    ...
    parser.add_argument(
        "--sted",
        default=True,
        help="whether to perform temporal localization",
    )
    ...
    # temporal loss
    parser.add_argument("--loss_temporal_map", default=0, type=float)
    # temporal loss for anchor-based decoder
    ...
    # temporal loss for regression decoder
    ...
    # temporal loss for distribution decoder
    parser.add_argument("--loss_temporal_dist", default=1, type=float)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "DecomposedSTVG training and evaluation script", parents=[get_args_parser()]
    )
